...
def prepare_model(args, model):
    ...
    for name in qlayers:
        if "down_proj" in name:
            if args.w_down_had_groupsize > 0:
                qlayers[name].online_block_had = True
                qlayers[name].online_had_groupsize = args.w_down_had_groupsize
            else:
        ...
        for name in qlayers:
            ...
            if "v_proj" in name and args.v_bits < 16:  # Set the v_proj precision
                ...
                qlayers[name].out_quantizer.configure(
                    ...
                    bfp_groupsize=args.v_bfp_groupsize,
                )
            ...
            qlayers[name].quantizer.configure(
                ...
                quant_method=args.a_quant_method,
                bfp_groupsize=args.a_bfp_groupsize,
            )
    ...
    if args.k_bits < 16:
        if args.k_pre_rope:
            ...
            k_quant_config = {
                ...
                "k_bfp_groupsize": args.k_bfp_groupsize,
                "qk_had_groupsize": args.qk_had_groupsize,
            }
            for layer in layers:
